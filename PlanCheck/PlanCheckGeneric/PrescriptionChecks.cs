...
{
    public class PrecriptionChecks : PlanCheckGeneric
    {
        ...
        public override void RunTest(PlanSetup plan)
        {
            ...
            string prefixFractoins = "";
            string prefixDperF = "";
            string prefixTotalDose = "";
            //string prefixId = "";
            //string prefixTechnique = "";
            //string prefixModes = "";
            //string prefixEnergies = "";
            //string prefixPrimTarget = "";
            //string prefixGating = "";
            //string prefixBolus = "";
